Marina — portable запуск для Windows

1. Распакуйте весь архив Marina.
2. Откройте папку portable.
3. Дважды щёлкните start-marina.bat.
4. Marina откроется в Microsoft Edge по адресу http://localhost:8765/
